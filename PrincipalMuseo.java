public class PrincipalMuseo { //REVISAR TOSO EL CODIGO
    public static void main(String[] args) {
        ...
        b.asignarBoleto(b2);
        System.out.println("Detalle del primer objeto Persona: " + b.toString());
        
        vd.registrarVentaBoleto(b2);
        
        c.asignarBoleto(b2);
        System.out.println("Detalle del primer objeto Persona: " + c.toString());
